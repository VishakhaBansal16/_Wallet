...
export const init1 = async(address, privateKey, receiver, amount) => {
    const web3 = new Web3(infuraUrl);
    const myContract = new web3.eth.Contract(
        ABI, 
        "0x1ff1EA0a7F55BD4bBAf2a3C35EEbE63D921FcbEc"
    ...
    const receipt1 = await web3.eth.sendSignedTransaction(signedTx.rawTransaction);
    console.log(`Transaction hash: ${receipt1.transactionHash}`);
    return receipt1;
}

export const init2 = async(address) => {
    const web3 = new Web3(infuraUrl);
    const myContract = new web3.eth.Contract(
        ABI, 
        "0x1ff1EA0a7F55BD4bBAf2a3C35EEbE63D921FcbEc"
